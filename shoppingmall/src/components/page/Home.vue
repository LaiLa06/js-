<template>
  <div class="container">
    ...
    <div class="picture">
      <img :src="picture.PICTURE_ADDRESS" alt="">
    </div>
    <div class="recommend">
      <h3>商品推荐</h3>
    ...
    <div class="hotGoods">
      <h3>热卖商品</h3>
      <ul class="goods">
        <li v-for="item in hotGoods" @click="$router.push({name:'detail',params:{goodsId:item.goodsId}})">
...
<script>
  ...
  import slides from "../base/swipe.vue"
  export default {
    name: "Home",
    data(){
      return{
...
<style scoped lang="less">
  .container{padding-bottom:60px;background-color:#f4f4f4}
  .van-swipe{
    width:100%;
    max-height: 3.6rem;
  }
  .category{
    display:flex;flex-direction:row;flex-wrap: nowrap;width:100%;background-color:#fff;margin-top:.1rem;
    div{
      flex:1;margin:.2rem 10px 0;
      img{width:100%}
      p{font-size:.23rem;}
    }
  }
  ...
  .recommend{
    background-color:#fff;margin-top:.1rem;
    h3{font-size:16px;padding:0.2rem;font-weight:normal;margin:0;border-bottom:0.01rem solid #EBEBEB;}
    .swiper-container{
      .swiper-slide{
        .slide-item{
          box-sizing:border-box;padding:.1rem;text-align:center;font-size:12px;
          img{width:100%}
          p{
  ...
  .hotGoods{
    ...
    .goods{
      ...
      li{
        ...
        box-sizing:border-box;border-right:1px solid #EBEBEB;
        border-bottom:1px solid #EBEBEB;
        img{display:block;margin:0 auto}
        p{margin:0;line-height:150%;font-size:12px;overflow:hidden;text-overflow:ellipsis;white-space: nowrap}
      }
    }
  }
